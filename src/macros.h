...
char DUMMY(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r) { return 1; }
char ocPRERAMP(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r) { if (m) return 1; return 0; }
...
char Gc(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
char gc(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
...
char altsc(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
char percentc(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
char midicctargetc(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
...
char mc(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
char Ec(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
char ec(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
char Hc(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
char hc(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
char Wc(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
char wc(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
char Lc(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
char lc(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
char Xc(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
char xc(jack_nframes_t fptr, uint16_t *spr, int m, Channel *cv, Row r);
