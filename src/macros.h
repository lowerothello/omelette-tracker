...
typedef struct {
	...
	uint8_t         flags; /* MACRO_FLAG declares or'd together */
...
const MacroDef global_macro_db[128] =
{
	...
	['g'] = { 1, "smooth stereo gain"          , MACRO_GROUP_GAIN     , MACRO_FLAG_LINKNIBBLES                , macroSmoothGain           , },
	['J'] = { 1, "stereo gain jitter"          , MACRO_GROUP_GAIN     , MACRO_FLAG_LINKNIBBLES|MACRO_FLAG_RAMP, macroGainJitter           , },
	['j'] = { 1, "smooth stereo gain jitter"   , MACRO_GROUP_GAIN     , MACRO_FLAG_LINKNIBBLES                , macroSmoothGainJitter     , },
	['S'] = { 1, "stereo send"                 , MACRO_GROUP_GAIN     , MACRO_FLAG_LINKNIBBLES|MACRO_FLAG_RAMP, macroSend                 , },
	['s'] = { 1, "smooth stereo send"          , MACRO_GROUP_GAIN     , MACRO_FLAG_LINKNIBBLES|MACRO_FLAG_RAMP, macroSmoothSend           , },
	['K'] = { 1, "stereo send jitter"          , MACRO_GROUP_GAIN     , MACRO_FLAG_LINKNIBBLES                , macroSendJitter           , },
	['k'] = { 1, "smooth stereo send jitter"   , MACRO_GROUP_GAIN     , MACRO_FLAG_LINKNIBBLES                , macroSmoothSendJitter     , },
	// ['N'] = { 1, "tremolo"                     , MACRO_GROUP_GAIN     , 0                                     , NULL                      , }, /* TODO */
	// ['n'] = { 1, "autopan"                     , MACRO_GROUP_GAIN     , 0                                     , NULL                      , }, /* TODO */
	['F'] = { 1, "stereo cutoff"               , MACRO_GROUP_FILTER   , MACRO_FLAG_LINKNIBBLES|MACRO_FLAG_RAMP, macroCutoff               , },
	['f'] = { 1, "smooth stereo cutoff"        , MACRO_GROUP_FILTER   , MACRO_FLAG_LINKNIBBLES                , macroSmoothCutoff         , },
	/* TODO: cutoff jitter */
	['Z'] = { 1, "stereo resonance"            , MACRO_GROUP_FILTER   , MACRO_FLAG_LINKNIBBLES|MACRO_FLAG_RAMP, macroResonance            , },
	['z'] = { 1, "smooth stereo resonance"     , MACRO_GROUP_FILTER   , MACRO_FLAG_LINKNIBBLES                , macroSmoothResonance      , },
	/* TODO: resonance jitter */
	['M'] = { 1, "stereo filter mode"          , MACRO_GROUP_FILTER   , MACRO_FLAG_LINKNIBBLES                , macroFilterMode           , },
	['m'] = { 1, "smooth stereo filter mode"   , MACRO_GROUP_FILTER   , MACRO_FLAG_LINKNIBBLES                , macroSmoothFilterMode     , },
	...
	['O'] = { 1, "sample offset"               , MACRO_GROUP_LOCAL    , MACRO_FLAG_RAMP                       , macroOffset               , },
	['o'] = { 1, "reverse sample offset"       , MACRO_GROUP_LOCAL    , MACRO_FLAG_RAMP                       , macroReverseOffset        , },
	['U'] = { 1, "sample offset jitter"        , MACRO_GROUP_LOCAL    , MACRO_FLAG_RAMP                       , macroOffsetJitter         , },
	['u'] = { 1, "reverse sample offset jitter", MACRO_GROUP_LOCAL    , MACRO_FLAG_RAMP                       , macroReverseOffsetJitter  , },
};
bool macroOffset                 (jack_nframes_t fptr, uint16_t *spr, int m, Track *cv, Row r);
bool macroReverseOffset          (jack_nframes_t fptr, uint16_t *spr, int m, Track *cv, Row r);
bool macroOffsetJitter           (jack_nframes_t fptr, uint16_t *spr, int m, Track *cv, Row r);
...
#define MACRO_LINKNIBBLES(x) (global_macro_db[(size_t)x].flags&MACRO_FLAG_LINKNIBBLES)
#define MACRO_RAMP(x)        (global_macro_db[(size_t)x].flags&MACRO_FLAG_RAMP       )
