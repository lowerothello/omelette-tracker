...
void macroGranularPostTrig(jack_nframes_t fptr, uint16_t *spr, Track *cv, Row *r)
{
...
void macroGranularTriggerNote(jack_nframes_t fptr, Track *cv, uint8_t oldnote, uint8_t note, short inst)
{
	/* local controls */
