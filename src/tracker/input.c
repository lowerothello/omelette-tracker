		...
		case PAGE_TRACK_VARIANT:
			...
			switch (w->mode)
			{
				case T_MODE_NORMAL:
					...
					addTooltipBind(tt, "put"                   , 0                   , XK_p           , 0              , putPartPatternPointer            , (void*)1 );
					addTooltipBind(tt, "mix put"               , 0                   , XK_P           , 0              , mixPutPartPatternPointer         , (void*)0 );
